...
@section('title',__('admin_about_us_cards.update_card_order'))
...
@section('content')
  ...
  <div class="page-body pt-5">
      ...
      <div class="page-header">
        <div class="row">
          <div class="col-7">
            <div class="row">
                <div class="col-7">
                    <h3>{{__('admin_about_us_cards.order_content')}} @if(count($langs) != 1)<span class="title-lang-code">({{ request('lang_code') }})</span>@endif</h3>
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item disappear-500">{{__('admin_about_us_cards.order_content')}}</li>
                    </ol>
                </div>
                <div class="col-5">
                    <!--
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form class="js-validation" action="{{ route('admin.about-us-cards-settings.update',[$cards[0]->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                  ...
                  <div class="item" style="background-image: url({{ asset('admin-asset/gray-scale.png') }}), url({{ asset($item->image_large_screen) }});">
                    <div class="d-flex row m-1">
                      ...
                      <div class="col-2 px-2 ms-3">
                        <a class="btn btn-sm btn-primary px-2" href="{{ route('admin.about-us-cards  -settings.edit', [$item->id]) }}">
                          <i class="fa fa-pencil-alt"></i>
                        </a>
                      </div>
                      <div class="col-2" onclick="return confirm('{{__('admin_about_us_cards.delete_question')}}')">
                        <div class="col-2">
                          <a class="btn btn-sm btn-danger px-2" href="{{ route('admin.about-us-cards-settings.destroy', $item->id) }}">
                      ...
                      <p class="item-passive">
                        {{__('admin_about_us_cards.table_passive')}}
                      </p>
                    </div>
                  @else
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                  <div class="input-group" >
                    <small class="font-weight-bold ms-2">{{__('admin_about_us_cards.drag_to_order')}}</small>
                    <input style="width:100%;" type="submit" class="btn btn btn-primary my-2 mx-1" id="updateaboutuscardsorder" name="updateaboutuscardsorder" value="{{__('admin_about_us_cards.save_order')}}">
                  </div>
                </div>
              </div>
            </div>
