...
<div class="page-body pt-5">
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <form class="theme-form needs-validation" novalidate="" action="{{ route('admin.app-maintenance.store') }}" method="POST">
          @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                <div class="input-group" >
                  <input style="width:100%;" type="submit" class="btn btn-primary" id="addappmaintenance" data-toggle="click-ripple" name="addappmaintenance" value="{{__('admin_app_maintenance.save')}}">
                </div>
              </div>
            </div>
          </div>
