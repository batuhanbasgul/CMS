...
@section('title',__('admin_product.update_image'))
...
<div class="page-body pt-5">
  <div class="container-fluid">
    <div class="page-header">
      <div class="row">
        <div class="col-7">
          <h3>{{__('admin_product.update_product_image')}}</h3>
          <ol class="breadcrumb">
            <li class="breadcrumb-item disappear-500"><a href="{{ route('admin.index') }}"><ins>{{__('admin_product.main_page')}}</ins></a></li>
            <li class="breadcrumb-item disappear-500">{{__('admin_product.product_image')}}</li>
            <li class="breadcrumb-item disappear-500">{{__('admin_product.update_product_image')}}</li>
          </ol>
        </div>
        <div class="col-5 d-flex justify-content-end">
          <a class="mx-5" href="{{ route('admin.products-settings.index',['lang_code' => $lang_code]) }}">
  ...
  <script>swal("{{__('admin_product.error')}}", "{{__('admin_product.update_success_context')}}", "error");</script>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('admin.product-images.update',[$image->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Image Cropper -->
            <div class="row items-push d-flex align-items-stretch">
              <div class="col-xxl-6">
                <h4 class="border-bottom pb-2">{{__('admin_product.image')}}</h4>
                <!--
                ...
                <div id="box-multi" class="block-content text-center d-none cropper-buttons">
                  <div class="row">
                    ...
                    data-method="crop-multi" title="{{__('admin_product.crop_popup')}}">
                ...
                <div class="row">
                  <input type="submit" class="btn btn-lg btn-primary updateimagebutton" id="updateimagemulti" name="updateimagemulti" value="{{__('admin_product.update')}}">
                </div>
              </div>
