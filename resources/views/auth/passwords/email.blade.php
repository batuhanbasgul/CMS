            ...
            <div class="login-card">
              <div class="login-main">
                <form class="theme-form login-form" action="{{ route('password.email') }}" method="POST">
                  ...
                  <div class="mb-3">
                    <h4 style="text-align: center;">{{__('auth_pages.reset_password')}}</h4>
                  </div>
                  @if (session('status'))
                  ...
                  @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                            <input class="form-control" type="email" id="email" name="email" placeholder="example@gmail.com" required="" autocomplete="email" autofocus>
                        </div>
                        </div>
                    </div>
                    <div class="form-group">
